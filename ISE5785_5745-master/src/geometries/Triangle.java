...
public class Triangle extends Polygon {
    ...
    public List<Point> findIntersections(Ray ray){
        ...
        primitives.Vector v1 = vertices.get(0).subtract(ray.head);
        primitives.Vector v2 = vertices.get(1).subtract(ray.head);
        primitives.Vector v3 = vertices.get(2).subtract(ray.head);


        //we want to get a normal for each pyramid's face so we do the crossProduct
        primitives.Vector n1 = v1.crossProduct(v2).normalize();
        primitives.Vector n2 = v2.crossProduct(v3).normalize();
        primitives.Vector n3 = v3.crossProduct(v1).normalize();
