...
class ImageWriterTest {
    ...
    Color yellowColor = new Color(1d, 255d, 255d); // Yellow is a combination of red & green (for the yellow Square)
    Color redColor = new Color(251d, 129d, 99d); // if r=255 the color is red (for the net)
